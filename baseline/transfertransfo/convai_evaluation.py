...
# NOTE: how does projects work? why I have to run setup.py?
...
class TransformerAgent(Agent):
    ...
    def __init__(self, opt, shared=None):
        ...
        # when shared is NOT None, we are a clone. Use the shared dict to set any variables.
    ...
    def act(self):
        ...
        if self.args.eval_type == "hits@1" and len(self.candidates) > 0:
            ...
            # 按照mc_logits从大到小排列candidates
            val, ind = torch.sort(mc_logits[0], descending=True)

            # match
            ypred = self.candidates[ind[0].item()][1]
            tc = []
...
if __name__ == '__main__':
    ...
    parser.set_params(
        # 指定agent，convai_evaluation.py中的TransformerAgent类
